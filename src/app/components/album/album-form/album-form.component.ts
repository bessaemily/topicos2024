...
@Component({
    ...
    imports: [NgIf, ReactiveFormsModule, MatFormFieldModule,
      MatInputModule, MatButtonModule, MatCardModule, MatToolbarModule, RouterModule, MatSelectModule, FormsModule],
  ...
  export class AlbumFormComponent implements OnInit{
    ...
    constructor(private formBuilder: FormBuilder,
      ...
      this.formGroup = formBuilder.group({
        ...
        id_artista: [(album && album.id_artista) ? album.id_artista : ''],
        id_genero: [(album && album.id_genero) ? album.id_genero : ''],
        id_gravadora: [(album && album.id_gravadora) ? album.id_gravadora : ''],
        produto: [(album && album.produto) ? album.produto : ''],
